...
LMD18200::LMD18200(PinName const _pwm, PinName const _dir, PinName const _br,
    ...
    : dir_fwd(_dir_fwd), pwm(_pwm), dir(_dir), br(_br) {
  pwm.period(_period);
  put(0.0f);
...
float LMD18200::getPwm() { return pwm.read(); }

bool LMD18200::getDir() { return dir; }

bool LMD18200::getBreak() { return br; }

void LMD18200::put(float const _duty) {
  if (_duty >= 0.0f) {
    setDirection(DIR_FORWARD);
...
void LMD18200::setBreak(bool const _break) { br = _break; }
