...
public:
    ...
    void generic_send(COMMAND cmd, uint8_t argc, NoTypeDataPack... args);
};

template<typename... NoTypeDataPack>
void Ctfcom::generic_send(COMMAND cmd, uint8_t argc, NoTypeDataPack... args){
    int len = sizeof...(args) +1;
